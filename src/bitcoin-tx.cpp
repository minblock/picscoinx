...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s picscoinx-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  picscoinx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded picscoinx transaction") + "\n" +
              "  picscoinx-tx [options] -create [commands]   " + _("Create hex-encoded picscoinx transaction") + "\n" +
              "\n";
