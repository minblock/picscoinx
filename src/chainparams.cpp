...
{
    const char* pszTimestamp = "2021-06-11 Provigen Networks: Now accepting Inaneasytoreadonelineversiontoomuchhtmlanddockercodeallovertheplaceshtotittieshttp://provgn.com/alternativebitcoins.html!";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("983040fda6216a0fbf67a2e4023fd6d4db046cb8b26e3d4aac80ce1565213d00");
        ...
        consensus.defaultAssumeValid = uint256S("0x983040fda6216a0fbf67a2e4023fd6d4db046cb8b26e3d4aac80ce1565213d00"); //1441280
        ...
        genesis = CreateGenesisBlock(1623429665, 493457, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x983040fda6216a0fbf67a2e4023fd6d4db046cb8b26e3d4aac80ce1565213d00"));
        assert(genesis.hashMerkleRoot == uint256S("0x02cf1bc69435d2060241ff1a23865724b5d0b2897387488c26d5922f97be9598"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.picscoinx.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.picscoinxtools.com");
        //vSeeds.emplace_back("dnsseed.picscoinxpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xab2fd3a28cf7f480bb18858dcdad2bae6a259a5c3bcae83915162547d6291b0e"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 849379, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xab2fd3a28cf7f480bb18858dcdad2bae6a259a5c3bcae83915162547d6291b0e"));
        assert(genesis.hashMerkleRoot == uint256S("0x02cf1bc69435d2060241ff1a23865724b5d0b2897387488c26d5922f97be9598"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.picscoinxtools.com");
        //vSeeds.emplace_back("seed-b.picscoinx.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x32d94aea5a2de3c52c48c03a113a9f00746e2814515d6c22362713c00a2326bd"));
        assert(genesis.hashMerkleRoot == uint256S("0x02cf1bc69435d2060241ff1a23865724b5d0b2897387488c26d5922f97be9598"));
