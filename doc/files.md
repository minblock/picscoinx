...
* picscoinx.conf: contains configuration settings for picscoinxd or picscoinx-qt
* picscoinxd.pid: stores the process id of picscoinxd while running
...
* debug.log: contains debug information and general logging generated by picscoinxd or picscoinx-qt
