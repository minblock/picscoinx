...
"""Verify that starting picscoinx with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start picscoinx with -h for help text")
        ...
        self.log.info("Start picscoinx with -version for version information")
